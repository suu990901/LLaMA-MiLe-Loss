...
def main():
    ...
    parser.add_argument('--subset', type=str, default='00')
    ...
    save_file = intermediate_dir / f"subset_{args.subset}.jsonl"
    processed_ds.to_json(save_file,num_proc=args.nproc)
